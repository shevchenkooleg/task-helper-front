...
export const createConsignmentNote = createAsyncThunk<void, string, ThunkConfig<string> >(
    'orderDetails/createConsignmentNote',
    async (orderId, thunkAPI) => {
        ...
        try {
            ...
            const response = await extra.api.post<responseInterface, AxiosResponse, Order>(`/order/${orderId}/createConsignment`,
                {},
                {
                    headers: {
