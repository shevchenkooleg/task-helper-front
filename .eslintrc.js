module.exports = {
    ...
    plugins: ['@typescript-eslint', 'react', 'unused-imports', 'path-import-validation-plugin','react-hooks'],
    rules: {
        ...
        'path-import-validation-plugin/public-api-imports': ['error', {
            alias: '@',
            testFilesPatterns: ['**/*.test.*', '**/*.stories.tsx', '**/StoreDecorator.tsx']
        }],
        'path-import-validation-plugin/layer-imports': ['error', {
            alias: '@',
